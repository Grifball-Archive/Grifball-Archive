...
The **Grifball Archive** is a **public library** on the web: you read **here**, in the pages—search, and sidebar. The repository still holds the source files so anyone can **clone or download a ZIP** for offline or long-term preservation.
